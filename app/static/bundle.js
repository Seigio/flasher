...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	    ...
	    function App() {
	        ...
	        _this.state = {
	            jsonData: [],
	            data: _react2.default.createElement('h3', { className: 'loading' })
	        };
	        return _this;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function getJson() {
	            var json_promise = _jquery2.default.getJSON($SCRIPT_ROOT + '/get_json/testq_1.json');

	            json_promise.done(function (json) {
	                var jsonArr = _jquery2.default.map(json, function (el) {
	                    return el;
	                });
	                this.setState({ jsonData: jsonArr, data: _react2.default.createElement(_Deck2.default, { json: jsonArr }) });
	            }.bind(this));
	...
	var Deck = function (_Component) {
	    ...
	    _createClass(Deck, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var cards = [];
	            var onCorrect = this.handleCorrectAnswer;

	            if (this.props.json) {
	                cards = this.props.json.map(function (jsonObj) {
	                    return _react2.default.createElement(_Card2.default, { question: jsonObj.question, title: jsonObj.title,
	                        answer: jsonObj.answer, key: jsonObj.title, onCorrect: onCorrect.bind(_this2) });
	                });
	            }
	        ...
	        key: 'decrementCardView',
	        value: function decrementCardView() {
	        ...
	        key: 'incrementCardView',
	        value: function incrementCardView() {
	            var nextIndex = this.state.index + 1;
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'change', id: 'previous', name: 'previous', onClick: this.decrementCardView.bind(this) },
	                        'Previous'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'change', id: 'next', name: 'next', onClick: this.incrementCardView.bind(this) },
	                        'Next'
	                    )
	                )
	            );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AnswerHandler = __webpack_require__(163);

	var _AnswerHandler2 = _interopRequireDefault(_AnswerHandler);
	    ...
	    _createClass(Card, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_AnswerHandler2.default, { correct: onCorrect.bind(this), answer: this.props.answer })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AnswerHandler = function (_Component) {
	    _inherits(AnswerHandler, _Component);

	    function AnswerHandler(props) {
	        _classCallCheck(this, AnswerHandler);

	        var _this = _possibleConstructorReturn(this, (AnswerHandler.__proto__ || Object.getPrototypeOf(AnswerHandler)).call(this, props));
	    ...
	    _createClass(AnswerHandler, [{
	        key: 'updateAnswerText',
	        value: function updateAnswerText(e) {
	            this.setState({
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'form',
	                { name: 'check_ans', id: 'check_ans', onSubmit: function onSubmit(submitEvent) {
	                        return _this2.handleSubmit(submitEvent);
	                    } },
	                _react2.default.createElement('input', { autoFocus: true, type: 'text', name: 'answer', id: 'answer', placeholder: 'Answer',
	                    value: this.state.answerText, onChange: function onChange(e) {
	                        return _this2.updateAnswerText(e);
	                    } }),
	                _react2.default.createElement('input', { type: 'button', value: 'Check', id: 'submit_btn', onClick: this.checkAnswer.bind(this) })
	            );
	        }
	    }]);
